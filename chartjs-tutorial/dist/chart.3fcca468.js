...
exports.aA = almostWhole;
exports.aB = almostEquals;
exports.aC = _decimalPlaces;
exports.aD = _longestText;
exports.aE = _filterBetween;
exports.aF = _lookup;
exports.aG = getHoverColor;
exports.aH = clone$1;
exports.aI = _merger;
exports.aJ = _mergerIf;
exports.aK = _deprecated;
exports.aL = toFontString;
exports.aM = splineCurve;
exports.aN = splineCurveMonotone;
exports.aO = getStyle;
exports.aP = fontString;
exports.aQ = toLineHeight;
exports.aW = _angleDiff;
exports.aa = clearCanvas;
exports.ab = _elementsEqual;
exports.ac = getAngleFromPoint;
exports.ad = _readValueToProps;
exports.ae = _updateBezierControlPoints;
exports.af = _computeSegments;
exports.ag = _boundSegments;
exports.ah = _steppedInterpolation;
exports.ai = _bezierInterpolation;
exports.aj = _pointInLine;
exports.ak = _steppedLineTo;
exports.al = _bezierCurveTo;
exports.am = drawPoint;
exports.an = addRoundedRectPath;
exports.ao = toTRBL;
exports.ap = toTRBLCorners;
exports.aq = _boundSegment;
exports.ar = _normalizeAngle;
exports.as = getRtlAdapter;
exports.at = overrideTextDirection;
exports.av = restoreTextDirection;
exports.aw = noop;
exports.ax = distanceBetweenPoints;
exports.ay = _setMinAndMaxByKey;
exports.az = niceNum;
exports.b = isArray;
exports.c = color;
...
exports.y = exports.s = exports.r = exports.o = exports.n = exports.h = exports.g = exports.e = exports.d = exports.au = exports.aV = exports.aU = exports.aT = exports.aS = exports.aR = exports.a7 = exports.a2 = exports.a1 = exports.Z = exports.Y = exports.X = exports.T = exports.P = exports.K = exports.J = exports.H = exports.B = void 0;
...
exports.aT = RAD_PER_DEG;
const HALF_PI = PI / 2;
exports.H = HALF_PI;
const QUARTER_PI = PI / 4;
exports.aU = QUARTER_PI;
const TWO_THIRDS_PI = PI * 2 / 3;
exports.aV = TWO_THIRDS_PI;
...
class Chart {
  ...
  setActiveElements(activeElements) {
    ...
    const changed = !(0, _helpersSegment.ab)(active, lastActive);
  ...
  _handleEvent(e, replay) {
    ...
    changed = !(0, _helpersSegment.ab)(active, lastActive);
...
function toRadiusCorners(value) {
  return (0, _helpersSegment.ad)(value, ['outerStart', 'outerEnd', 'innerStart', 'innerEnd']);
}
...
class LineElement extends Element {
  ...
  updateControlPoints(chartArea) {
    ...
    if (options.tension && !options.stepped && !me._pointsUpdated) {
      ...
      (0, _helpersSegment.ae)(me._points, options, chartArea, loop);
  ...
  get segments() {
    return this._segments || (this._segments = (0, _helpersSegment.af)(this, this.options.segment));
  }
  ...
  interpolate(point, property) {
    ...
    const segments = (0, _helpersSegment.ag)(me, {
      property,
      start: value,
      end: value
    });
...
class PointElement extends Element {
  ...
  draw(ctx) {
    ...
    ctx.lineWidth = options.borderWidth;
    ctx.fillStyle = options.backgroundColor;
    (0, _helpersSegment.am)(ctx, options, me.x, me.y);
  }
...
function parseBorderWidth(bar, maxW, maxH) {
  ...
  const o = (0, _helpersSegment.ao)(value);
  return {
...
class BarElement extends Element {
  ...
  draw(ctx) {
    ...
    const addRectPath = hasRadius(outer.radius) ? _helpersSegment.an : addNormalRectPath;
    ctx.save();
...
function getBounds(property, first, last, loop) {
  ...
  if (property === 'angle') {
    start = (0, _helpersSegment.ar)(start);
    end = (0, _helpersSegment.ar)(end);
  }
...
function _segments(line, target, property) {
  ...
  for (const segment of segments) {
    ...
    const targetSegments = (0, _helpersSegment.ag)(target, bounds);

    for (const tgt of targetSegments) {
      const subBounds = getBounds(property, tpoints[tgt.start], tpoints[tgt.end], tgt.loop);
      const fillSources = (0, _helpersSegment.aq)(segment, points, subBounds);
...
class Legend extends Element {
  ...
  _draw() {
    ...
    const rtlHelper = (0, _helpersSegment.as)(opts.rtl, me.left, me.width);
    const labelFont = (0, _helpersSegment.W)(labelOpts.font);
    const {
      color: fontColor,
      padding
    ...
    const drawLegendBox = function (x, y, legendItem) {
      ...
      if (labelOpts.usePointStyle) {
        ...
        (0, _helpersSegment.am)(ctx, drawOptions, centerX, centerY);
      } else {
        const yBoxTop = y + Math.max((fontSize - boxHeight) / 2, 0);
        const xBoxLeft = rtlHelper.leftForLtr(x, boxWidth);
        const borderRadius = (0, _helpersSegment.ap)(legendItem.borderRadius);
        ctx.beginPath();

        if (Object.values(borderRadius).some(v => v !== 0)) {
          (0, _helpersSegment.an)(ctx, {
            x: xBoxLeft,
            y: yBoxTop,
            w: boxWidth,
            h: boxHeight,
    ...
    (0, _helpersSegment.at)(me.ctx, opts.textDirection);
    const lineHeight = itemHeight + padding;
    me.legendItems.forEach((legendItem, i) => {
      ...
      x = (0, _helpersSegment.au)(textAlign, x + boxWidth + halfFontSize, me.right);
  ...
  nearest(items, eventPosition) {
    ...
    for (i = 0, len = items.length; i < len; ++i) {
      ...
      if (el && el.hasValue()) {
        ...
        const d = (0, _helpersSegment.ax)(eventPosition, center);
...
class Tooltip extends Element {
  ...
  drawTitle(pt, ctx, options) {
    ...
    if (length) {
      const rtlHelper = (0, _helpersSegment.as)(options.rtl, me.x, me.width);
  ...
  _drawColorBox(ctx, pt, i, rtlHelper, options) {
    ...
    if (options.usePointStyle) {
      ...
      const borderRadius = (0, _helpersSegment.ap)(labelColors.borderRadius);
  ...
  draw(ctx) {
    ...
    if (options.enabled && hasTooltipContent) {
      ...
      (0, _helpersSegment.at)(ctx, options.textDirection);
      pt.y += padding.top;
  ...
  setActiveElements(activeElements, eventPosition) {
    ...
    const changed = !(0, _helpersSegment.ab)(lastActive, active);
  ...
  handleEvent(e, replay) {
    ...
    changed = replay || !(0, _helpersSegment.ab)(active, lastActive) || positionChanged;
...
var plugin_tooltip = {
  ...
  defaults: {
    ...
    callbacks: {
      beforeTitle: _helpersSegment.aw,
      ...
      afterTitle: _helpersSegment.aw,
      beforeBody: _helpersSegment.aw,
      beforeLabel: _helpersSegment.aw,
      ...
      afterLabel: _helpersSegment.aw,
      afterBody: _helpersSegment.aw,
      beforeFooter: _helpersSegment.aw,
      footer: _helpersSegment.aw,
      afterFooter: _helpersSegment.aw
    }
  },
  defaultRoutes: {
    bodyFont: 'font',
...
function generateTicks$1(generationOptions, dataRange) {
  ...
  let spacing = (0, _helpersSegment.az)((rmax - rmin) / maxSpaces / unit) * unit;
  ...
  if (numSpaces > maxSpaces) {
    spacing = (0, _helpersSegment.az)(numSpaces * spacing / maxSpaces / unit) * unit;
  }
  ...
  if (minDefined && maxDefined && step && (0, _helpersSegment.aA)((max - min) / step, spacing / 1000)) {
    ...
    if ((0, _helpersSegment.aB)(numSpaces, Math.round(numSpaces), spacing / 1000)) {
  ...
  factor = Math.pow(10, (0, _helpersSegment.j)(precision) ? (0, _helpersSegment.aC)(spacing) : precision);
  ...
  if (minDefined) {
    ...
    if ((0, _helpersSegment.aB)(Math.round((niceMin + j * spacing) * factor) / factor, min, spacing / 10)) {
      j++;
    }
  }
  ...
  if (maxDefined) {
    if ((0, _helpersSegment.aB)(ticks[ticks.length - 1].value, max, spacing / 10)) {
...
class LinearScaleBase extends Scale {
  ...
  buildTicks() {
    ...
    if (opts.bounds === 'ticks') {
      (0, _helpersSegment.ay)(ticks, me, 'value');
    }
...
function measureLabelSize(ctx, lineHeight, label) {
  if ((0, _helpersSegment.b)(label)) {
    return {
      w: (0, _helpersSegment.aD)(ctx, ctx.font, label),
...
class RadialLinearScale extends LinearScaleBase {
  ...
  getIndexAngle(index) {
    ...
    return (0, _helpersSegment.ar)(index * angleMultiplier + (0, _helpersSegment.t)(startAngle));
  }
...
function addTick(ticks, time, timestamps) {
  if (!timestamps) {
    ...
    const {
      lo,
      hi
    } = (0, _helpersSegment.aF)(timestamps, time);
...
class TimeScale extends Scale {
  ...
  buildTicks() {
    ...
    const min = me.min;
    const max = me.max;
    const ticks = (0, _helpersSegment.aE)(timestamps, min, max);
...
function interpolate(table, val, reverse) {
  ...
  if (reverse) {
    ...
    const result = (0, _helpersSegment.aF)(table, val);
...
},{"./chunks/helpers.segment.js":"node_modules/chart.js/dist/chunks/helpers.segment.js"}],"chart.ts":[function(require,module,exports) {
"use strict";
...
new chart_js_1.Chart($chart, {
  data: data,
  type: "line"
});
},{"chart.js":"node_modules/chart.js/dist/chart.esm.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","chart.ts"], null)
//# sourceMappingURL=/chart.3fcca468.js.map